...
int controller_addEmployee(LinkedList* pArrayListEmployee, int* id)
{
	 ...
	 if(pArrayListEmployee != NULL)
		 ...
		 do
		 {
			 ...
			 confirmacion = getYesOrNo("Desea cargar al empleado? Ingrese s para SI o n para NO: ");//pido confirmacion para cargar o cancelar la accion
			 if(confirmacion == 's')
			 {
       ...
       if(isEmpty!= 1)
       {
           ...
           if(auxEmpleado != NULL)
           {
               ...
               do
               {
                  ...
                  {
                  case 1:
                      checkString("Ingrese un nuevo nombre: ", auxEmpleado->nombre);
...
//a partir de aca funciones creadas fuera de las que daba el tp
...
int getNextId(LinkedList* pArrayListEmployee)
{
    ...
    if(pArrayListEmployee != NULL)
    {
        retorno = getBiggestId(pArrayListEmployee);
        retorno++;
    }
    return retorno;
}
